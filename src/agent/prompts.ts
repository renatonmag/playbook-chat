...
export function technicalAnalysisSystemPrompt({
  ...
  **What buyers need (Buying case):**
  ...
  - Use market_state as the primary source of context.
  - Use market_state.openQuestions only as uncertainty inside the reading, not as a separate questionnaire.
  - Do not return JSON.
